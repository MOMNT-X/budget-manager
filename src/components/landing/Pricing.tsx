...
const tiers = [
  {
    ...
    features: ["1 budget", "Connect 1 bank", "Basic insights", "Email support"],
    cta: "Start Free",
    highlighted: false,
  },
  {
  ...
  return (
    <section id="pricing" className="container mx-auto px-4 py-16 md:py-24">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        {tiers.map((t) => (
          <div key={t.name} className={`relative rounded-2xl border bg-card p-6 shadow-sm ${t.highlighted ? 'ring-2 ring-primary' : ''}`}>
